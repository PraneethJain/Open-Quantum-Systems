...
$ rho_21 (t) = rho_12 (0)^* e^(-2gamma t) = rho_22 (0) e^(-2 gamma t) $
Since $tr(rho) = 1$, $rho_22 = 1 - rho_11$
$ rho_22 (t) = 1 - rho_11 (0) e^(-gamma t) = rho_11 (0) + rho_22 (0) - rho_11 (0) e^(- gamma t) = (1- e^(-gamma t))rho_11 (0) + rho_22 (0)  $

Thus, we have
$ rho(t) = phi.alt(rho(0)) = mat(rho_11 (0)e^(-gamma t), rho_12 (0)e^(-2gamma t);
               rho_22 (0) e^(-2gamma t), (1- e^(-gamma t))rho_11 (0) + rho_22 (0)) $
...
$ F_00 = 1/2 tr(I phi.alt(I)) = 1/2 tr(phi.alt(I)) = 1/2 tr(mat(e^(-gamma t),0;0,2 - e^(-gamma t))) = 1 $
$ F_01 = 1/2 tr(I phi.alt(sigma_x)) = 1/2 tr(phi.alt(sigma_x)) = 1/2 tr(mat(0,  e^(-2 gamma t); e^(-2 gamma t), 0)) = 0 $
$ F_02 = 1/2 tr(I phi.alt(sigma_y)) = 1/2 tr(phi.alt(sigma_y)) = 1/2 tr(mat(0,  -i e^(-2 gamma t); i e^(-2 gamma t), 0)) = 0 $
$ F_03 = 1/2 tr(I phi.alt(sigma_z)) = 1/2 tr(phi.alt(sigma_z)) = 1/2 tr(mat(e^(-gamma t),  0; 0, - e^(- gamma t))) = 0 $
$ F_10 = 1/2 tr(sigma_x phi.alt(I)) = 1/2 tr(mat(0, 1; 1, 0) mat(e^(-gamma t),  0; 0, 2 - e^(- gamma t))) = 1/2 tr(mat(0, 2 - e^(-gamma t); e^(-gamma t), 0)) = 0 $
$ F_11 = 1/2 tr(sigma_x phi.alt(sigma_x)) = 1/2 tr(mat(0, 1; 1, 0) mat(0,  e^(-2 gamma t); e^(-2 gamma t), 0)) = 1/2 tr(mat(e^(-2 gamma t), 1; 0, e^(-2 gamma t))) = e^(-2 gamma t) $
$ F_12 = 1/2 tr(sigma_x phi.alt(sigma_y)) = 1/2 tr(mat(0, 1; 1, 0) mat(0,  -i e^(-2 gamma t); i e^(-2 gamma t), 0)) = 1/2 tr(mat(i e ^(-2 gamma t), 1; 0, -i e^(-2 gamma t))) = 0 $
$ F_13 = 1/2 tr(sigma_x phi.alt(sigma_z)) = 1/2 tr(mat(0, 1; 1, 0) mat(e^(-gamma t),  0; 0, - e^(- gamma t))) = 1/2 tr(mat(0, - e^(-gamma t); e^(-gamma t), 0)) = 0 $
$ F_20 = 1/2 tr(sigma_y phi.alt(I)) = 1/2 tr(mat(0, -i; i, 0) mat(e^(-gamma t),  0; 0, 2 - e^(- gamma t))) = 1/2 tr(mat(0, -2i + i e^(-gamma t); i e^(-gamma t), 0)) = 0 $
...
$ F_22 = 1/2 tr(sigma_y phi.alt(sigma_y)) = 1/2 tr(mat(0, -i; i, 0) mat(0,  -i e^(-2 gamma t); i e^(-2 gamma t), 0)) = 1/2 tr(mat(e^(-2 gamma t), -i; 0, e^(-2 gamma t))) = e^(-2 gamma t) $
$ F_23 = 1/2 tr(sigma_y phi.alt(sigma_z)) = 1/2 tr(mat(0, -i; i, 0) mat(e^(-gamma t),  0; 0, - e^(- gamma t))) = 1/2 tr(mat(0, i e^(-gamma t); i e^(-gamma t), 0)) = 0 $
$ F_30 = 1/2 tr(sigma_z phi.alt(I)) = 1/2 tr(mat(1, 0; 0, -1) mat(e^(-gamma t),  0; 0, 2 - e^(- gamma t))) = 1/2 tr(mat(e^(-gamma t), 0; 0, -2 + e^(-gamma t))) = e^(-gamma t) - 1 $
$ F_31 = 1/2 tr(sigma_z phi.alt(sigma_x)) = 1/2 tr(mat(1, 0; 0, -1) mat(0,  e^(-2 gamma t); e^(-2 gamma t), 0)) = 1/2 tr(mat(0, e^(-2 gamma t); -e^(-2 gamma t), 0)) = 0 $
$ F_32 = 1/2 tr(sigma_z phi.alt(sigma_y)) = 1/2 tr(mat(1, 0; 0, -1) mat(0,  -i e^(-2 gamma t); i e^(-2 gamma t), 0)) = 1/2 tr(mat(0, -i e^(-2 gamma t); -i e^(-2 gamma t), 0)) = 0 $
$ F_33 = 1/2 tr(sigma_z phi.alt(sigma_z)) = 1/2 tr(mat(1, 0; 0, -1) mat(e^(-gamma t),  0; 0, - e^(- gamma t))) = 1/2 tr(mat(e^(-gamma t), 0; 0, e^(-gamma t))) = e^(-gamma t) $

$ F = mat(1, 0, 0, 0; 0, e^(-2 gamma t), 0, 0; 0, 0, e^(-2 gamma t), 0; e^(-gamma t) - 1, 0, 0, e^(-gamma t)) $

Clearly, the matrix has determinant $!=0$.

Thus, the $F$ matrix corresponding to this map , and thus the map, *is* invertible.

Also, since this operation cannot be represented by a single unitary, it is *not* reversible.
